...
public class TaskList
{
    ...
    public void makeNewLine(final Task newTaskObject)
    {
        ...
        newLayout.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                setClick(newTaskObject, newLayout);
            }
        });
        ...
        newLayout.setOnLongClickListener(new View.OnLongClickListener()
        {
            ...
            {
                return setLongClick(newTaskObject, newLayout);
            }
        });


        for (int i = 1; i < newLayout.getChildCount(); i++)
        { // onclick listener for buttons and text
    ...
    private void setClick(Task newTaskObject, LinearLayout newLayout)
    {
        ...
        { // if not selected, toggle
            newTaskObject.toggleCheckButton();
        }
    }

    private boolean setLongClick(Task newTaskObject, LinearLayout newLayout)
    {
        if (!mInListEditMode)
        {
            if (!newTaskObject.isEditable())
